...
class DecisionEngine:
    ...
    def _base_evidence(self, snapshot: DecisionSnapshot) -> dict[str, Any]:
        return {
            ...
            "mouth_state": snapshot.mouth_state,
            "c3_risk_score": round(snapshot.c3_risk_score, 3),
            "c3_safe_score": round(snapshot.c3_safe_score, 3),
            "c3_penalty_points": round(snapshot.c3_penalty_points, 3),
            "near_miss_count": snapshot.near_miss_count,
            "microsleep_count": snapshot.microsleep_count,
