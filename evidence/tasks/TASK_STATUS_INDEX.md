...
| E-21 | Thiện | Nhân | PARTIAL | Source export + temp report screenshots captured; còn canonical KPI audit và DOC visual sample. |
| E-22 | Thiện | Nhân | PARTIAL | Source workflow + temporary UI screenshots captured; còn canonical video/screenshot. |
| E-23 | Thiện | Nhân | PARTIAL | Source failure states + empty screenshot captured; còn API-down/WebSocket/stale recovery media. |
| E-24 | Dân | Nhân | PARTIAL | CarSky command + source/APK path verified; còn same-event media/logcat bundle. |
...
<!-- E-22/E-23/E-39 update generated by Codex -->
- E-21: PARTIAL / SOURCE EXPORT VERIFIED; TEMP REPORT SCREENSHOTS CAPTURED; CANONICAL KPI AUDIT PENDING (`E-21/reports/source_report.md`).
- E-22: PARTIAL / SOURCE WORKFLOW VERIFIED; TEMPORARY UI SCREENSHOTS CAPTURED; CANONICAL VIDEO STILL REQUIRED (`E-22/reports/source_report.md`).
- E-23: PARTIAL / SOURCE FAILURE STATES VERIFIED; EMPTY STATE SCREENSHOT CAPTURED; FULL RUNTIME FAILURE MATRIX REQUIRED (`E-23/reports/source_report.md`).
- E-39: NOT EXECUTED / CLAIM CONTROL ONLY - NO HUMAN-FACTORS OUTCOME CLAIM (`E-39/reports/source_report.md`).
